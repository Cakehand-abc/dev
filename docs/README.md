...
| [02 数据库设计说明书](<deliverables/02 数据库设计说明书.docx>) | 18 张实际表的字段、索引及完整性约束 |
| [03 测试日志](<deliverables/03 测试日志.docx>) | 真实测试结果、缺陷回归与未执行项 |
| [04 系统架构设计说明书](<deliverables/04 系统架构设计说明书.docx>) | 系统分层、事务、安全与部署架构 |
| [05 测试用例](<deliverables/05 测试用例.docx>) | 28 项自动用例及浏览器、人工补充用例 |
...
- [项目运行说明](../README.md)，[接口目录](API.md)，[设备接入指南](DEVICE-INGEST.md)，[SQL 结构](../database/01-schema.sql)，[独立演示数据](../database/02-demo-data.sql)，[V1.0 升级脚本](../database/03-device-ingest-upgrade.sql)。
